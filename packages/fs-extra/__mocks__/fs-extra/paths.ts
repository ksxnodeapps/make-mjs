...
export const EXTERNAL_MODULE_PATH_NONMJS = joinPath(MODULE_CONTAINER, EXTERNAL_MODULE_NAME_NONMJS)
export const EXTERNAL_MODULE_MANIFEST_NONMJS = joinPath(EXTERNAL_MODULE_PATH_NONMJS, 'package.json')
export const EXTERNAL_MODULE_ENTRY_NONMJS = joinPath(EXTERNAL_MODULE_PATH_NONMJS, ENTRY_MAIN_JS)
export const EXTERNAL_MODULE_ENTRY_NONMJS_MJS = joinPath(EXTERNAL_MODULE_PATH_NONMJS, ENTRY_MAIN_JS)
