...
class Internal
extends Base<ModuleUrlKind.Internal, null>
implements InternalModuleUrlParsingResult {
  public readonly kind = ModuleUrlKind.Internal
}

class External
extends Base<ModuleUrlKind.External, string>
implements ExternalModuleUrlParsingResult {
